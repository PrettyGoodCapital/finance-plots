...
lint-py:  ## lint python with ruff
	python -m ruff check finance_plots
	python -m ruff format --check finance_plots
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix finance_plots
	python -m ruff format finance_plots
...
test:  ## run python tests
	python -m pytest -v finance_plots/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v finance_plots/tests --cov=finance_plots --cov-report term-missing --cov-report xml
